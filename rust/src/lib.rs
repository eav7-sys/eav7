//! EAV7 consensus library — protocol `eav20`.
//!
...
pub use block::{
    block_hash, block_validator, build_block, verify_block_integrity, verify_block_integrity_ex,
    Block, BlockSigner, BuildParams, GENESIS_PREVIOUS_HASH,
};
#[cfg(not(target_arch = "wasm32"))]
