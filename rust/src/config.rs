...
//!
//! GERADO por `node bin/eav7-config-rs.js` a partir de `src/config.js`. Não
//! edite à mão: a referência em JavaScript é a fonte única, e uma divergência
//! aqui faz este cliente aceitar o que a rede rejeita (ou o contrário).
//!
...
pub const PERMISSIONS_HEIGHT: u64 = 1500000;
pub const MAX_PERMISSION_KEYS: u64 = 20;
pub const PERMISSIONS_V2_HEIGHT: u64 = 1900000;
...
pub const GOVERNANCE_HEIGHT: u64 = 1700000;
...
pub const BRIDGE_QUORUM_HEIGHT: u64 = 1000000;
pub const BRIDGE_PROOF_HEIGHT: u64 = 1300000;
pub const CANONICAL_HASH_HEIGHT: u64 = 1000000;
pub const STATEROOT_HEIGHT: u64 = 1200000;
pub const FINALITY_MIN_VALIDATORS: u64 = 3;
pub const BRIDGE_BREAKER_HEIGHT: u64 = 100000000;
...
pub const AI_ACCOUNTABILITY_HEIGHT: u64 = 1760000;
pub const AI_ORACLE_SLASH: u128 = 10000000;
pub const AI_QUORUM_HEIGHT: u64 = 1780000;
...
pub const AI_CHALLENGE_HEIGHT: u64 = 1800000;
...
pub const AI_MARKET_HEIGHT: u64 = 1820000;
pub const AI_BID_WINDOW_MS: u64 = 1800000;
pub const AI_PRIVATE_HEIGHT: u64 = 1840000;
...
pub const RESOURCE_HEIGHT: u64 = 1600000;
pub const VESTING_HEIGHT: u64 = 1650000;
pub const MAX_VESTING_BLOCKS: u64 = 315360000;
pub const META_HEIGHT: u64 = 1680000;
pub const TOKEN_ADMIN_HEIGHT: u64 = 1700000;
pub const NFT_HEIGHT: u64 = 1720000;
pub const MAX_NFT_URI_BYTES: u64 = 2048;
pub const NAME_HEIGHT: u64 = 1740000;
pub const NAME_REGISTER_COST: u128 = 1000000;
pub const MAX_FEE_LIMIT: u128 = 100000000;
pub const GAS_PER_ENERGY: u64 = 100;
pub const EAVM_VALUE_HEIGHT: u64 = 1900000;
pub const EAVM_CONTRACTS_HEIGHT: u64 = 1900000;
pub const EAVM_OSAKA_HEIGHT: u64 = 1900000;
...
pub const FORK_HEIGHTS: &[(&str, u64)] = &[
    ("STRICT_PRODUCER_HEIGHT", 49500),
    ("CANONICAL_HASH_HEIGHT", 1000000),
    ("STATEROOT_HEIGHT", 1200000),
    ("BRIDGE_QUORUM_HEIGHT", 1000000),
    ("BRIDGE_PROOF_HEIGHT", 1300000),
    ("VOTING_HEIGHT", 1400000),
    ("PERMISSIONS_HEIGHT", 1500000),
    ("RESOURCE_HEIGHT", 1600000),
    ("GOVERNANCE_HEIGHT", 1700000),
    ("VESTING_HEIGHT", 1650000),
    ("META_HEIGHT", 1680000),
    ("TOKEN_ADMIN_HEIGHT", 1700000),
    ("NFT_HEIGHT", 1720000),
    ("NAME_HEIGHT", 1740000),
    ("AI_ACCOUNTABILITY_HEIGHT", 1760000),
    ("AI_QUORUM_HEIGHT", 1780000),
    ("AI_CHALLENGE_HEIGHT", 1800000),
    ("AI_MARKET_HEIGHT", 1820000),
    ("AI_PRIVATE_HEIGHT", 1840000),
    ("EAVM_VALUE_HEIGHT", 1900000),
    ("PERMISSIONS_V2_HEIGHT", 1900000),
    ("EAVM_CONTRACTS_HEIGHT", 1900000),
    ("EAVM_OSAKA_HEIGHT", 1900000),
];
...
pub const GENESIS_ACTIVE_BUILD: bool = false;
