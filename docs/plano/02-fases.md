...
## 1. Referência em JavaScript — pronta
...
**As 34 rotas da API existem nos dois clientes.** Nenhuma ficou só no JavaScript.
...
## 6. Aposentadoria do JavaScript — aguarda ordem explícita
