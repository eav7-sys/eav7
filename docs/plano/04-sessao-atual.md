...
|---|---|---|
| **Unidade em `/stats`** | Montantes saíam já divididos por `UNIT`, exceção só dessa rota. O cliente dividia de novo: 7.900 EAV7 apareciam como 0,0079. Além disso `Number` sobre e7 estoura o inteiro seguro do protocolo aos 900 milhões de EAV7. | Tela mostra "10 mil" contra o nó real |
...
Tudo aplicado **nos dois clientes**. A produção ainda roda o Rust; corrigir
...
- 982 testes Rust, 378 protocolo, `tsc` limpo, `next build` limpo
