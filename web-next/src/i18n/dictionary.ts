...
const en: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Native tokens (EAV20)", bridge: "Lock-and-release across chains", security: "Post-quantum + surveillance",
...
const es: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Tokens nativos (EAV20)", bridge: "Lock-and-release entre redes", security: "Poscuántica + vigilancia",
...
const zh: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "原生代币（EAV20）", bridge: "跨链锁定与释放", security: "抗量子 + 监控",
...
const fr: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Jetons natifs (EAV20)", bridge: "Lock-and-release entre réseaux", security: "Post-quantique + surveillance",
...
const de: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Native Token (EAV20)", bridge: "Lock-and-Release zwischen Netzwerken", security: "Post-Quanten + Überwachung",
...
const ja: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "ネイティブトークン（EAV20）", bridge: "ネットワーク間のロック＆リリース", security: "耐量子 + 監視",
...
const ru: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Нативные токены (EAV20)", bridge: "Lock-and-release между сетями", security: "Постквантовая + наблюдение",
...
const ar: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "رموز أصلية (EAV20)", bridge: "القفل والإطلاق بين الشبكات", security: "ما بعد الكم + المراقبة",
...
const hi: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "मूल टोकन (EAV20)", bridge: "नेटवर्कों के बीच लॉक-एंड-रिलीज़", security: "पोस्ट-क्वांटम + निगरानी",
...
const ko: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "네이티브 토큰(EAV20)", bridge: "네트워크 간 락앤릴리스", security: "포스트 양자 + 감시",
...
const it: Messages = {
  ...
  menu: {
    ...
    d: {
      ...
      standard: "Token nativi (EAV20)", bridge: "Lock-and-release tra reti", security: "Post-quantistica + sorveglianza",
