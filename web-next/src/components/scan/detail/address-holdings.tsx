 ...
 *
 * O desenho tem uma aba "DeFi" e valores em dólar. Nenhum dos dois existe na EAV7 —
 * a aba saiu e a coluna de valor mostra a QUANTIDADE do ativo, que é o dado real.
 */
      ...
      >
        {lista.map((it) => (
          ...
          >
            ...
            <span className="tnum shrink-0 text-right text-[12.5px] font-semibold text-ink">{it.amount}</span>
          </div>
        ))}
        {lista.length === 0 ? (
