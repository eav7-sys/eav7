...
export const DOCS: Record<string, Doc> = {
    ...
    sections: [
      ...
      },
      {
        ...
        kv: [
          ...
          ["Tempo de bloco", "1 segundo (3× mais rápido que a Tron)"],
          ["Consenso", "DPoS — até 27 validadores (governável, teto 101) eleitos por peso (stake + votos), finalidade BFT"],
    ...
    sections: [
      {
        ...
        p: "Contas com stake ≥ 1.000 EAV7 entram na eleição; as 27 de maior PESO (self-stake + votos recebidos via VOTE) tornam-se validadores ativos. Sem votos, degrada para top-por-stake — como os 27 Super Representatives da Tron.",
      },
      {
      ...
      {
        h: "Rodar um nó",
        code: "node bin/eav7.js mine --port 6070 \\\n  --peers https://outro-no:6070 \\\n  --genesis-hash E7...",
      },
    ],
  },
  staking: {
    ...
    sections: [
      ...
      },
      {
        ...
        code: "node bin/eav7.js stake --wallet w.json --amount 1000\nnode bin/eav7.js unstake --wallet w.json --amount 500",
      },
    ],
  },
  eavm: {
  ...
  token: {
    ...
    sub: "Ativos nativos do protocolo (equivalentes ao TRC20 / TRC721)",
    sections: [
      {
  ...
  ponte: {
    ...
    sections: [
      {
        p: "A ponte conecta a EAV7 a outras redes (TRON, ETH, BTC…) por um modelo lock-and-release. A liberação de fundos NÃO depende da confiança em um relayer: exige prova criptográfica do evento de origem, assinada por um comitê (quórum M-de-N).",
      },
      {
        h: "Fluxo",
        kv: [
